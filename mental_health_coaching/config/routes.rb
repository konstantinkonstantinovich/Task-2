Rails.application.routes.draw do
  ...
  get '/user/coaches/invitation/:coach_id', to: "invitations#new", as: 'invitation'
  post 'user/coaches/invitation/:coach_id', to: "invitations#create", as: 'send_invite'
  delete 'cancel/:invite_id', to: 'invitations#cancel_invite', as: 'cancel_coach_invite'
  get '/user/ask', to: 'invitations#modal_ask_form', as: 'asking_form'
  delete 'end/:invite_id', to: 'invitations#destroy', as: 'end_cooperation_coach_invite'
  ...
  get '/user/room/:room_id', to: 'room#index', as: 'chat_room_user'
